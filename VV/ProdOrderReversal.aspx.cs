        ...
        protected void btnReverse_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow row in grdViewWIPResult.Rows)
            {
                ...
                if (isChecked)
                {
                    ...
                    _DBObj.ProductionOrderReversal(Int32.Parse(OrderNo.Trim()), LineNum.Trim(), Int32.Parse(Pos.Trim()), ProdOrderNo.Trim(), SerialNo.Trim(), Int32.Parse(BalanceQty.Trim()), StoresIssued.Value);
                }
            }
