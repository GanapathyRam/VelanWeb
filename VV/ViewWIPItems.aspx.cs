...
namespace VV
{
    public partial class ViewWIPItems : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                grdViewWIPResult.PageSize = Convert.ToInt32(pageSize);
        ...
        protected void grdViewWIPResult_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            {
                Logger.Write(this.GetType().ToString() + " : View WIP To FG - When trying to do a Paging : " + " : " + DateTime.Now + " : " + ex.Message.ToString(), Category.General, Priority.Highest);
                throw ex;
            }
        }
        ...
        protected void btnSearchBox_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!String.IsNullOrEmpty(searchRowFilter))
                {
                    DataSet searchDS = (DataSet)Cache["WIPDataFromDBCache"];
