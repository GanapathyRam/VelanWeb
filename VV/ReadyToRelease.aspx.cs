...
namespace VV
{
    public partial class ReadyToRelease : System.Web.UI.Page
    {
        ...
        protected void btnSearchBox_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DataSet searchDS = (DataSet)Cache["MISReadyToRelease"];
                    ...
                    Cache["MISReadyToRelease"] = ds;
                }
                else if (string.IsNullOrEmpty(searchRowFilter1))
                {
                    DataSet searchDS = _DBObj.RetriveByMISReadyToReleaseDetails();
                    Cache["MISReadyToRelease"] = searchDS;
        ...
        protected void btnExcelExport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                DataSet ds = (DataSet)Cache["MISReadyToRelease"];
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    Response.AddHeader("content-disposition", string.Format("attachment; filename={0}", "ReadyToRelease.xls"));
            ...
            {
                Helper.LogError(ex, "Exception from export button click from Ready To Release!");
            }
        }

        private void GetReadyToReleaseDetails()
        {
            try
            {
                ...
                DataSet ds = _DBObj.RetriveByMISReadyToReleaseDetails();
                Cache["MISReadyToRelease"] = ds;
            ...
            {
                LogError(ex, "Exception from display ready to release details.");
            }
        }
        ...
        protected void GridView1_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            {
                LogError(ex, "Exception from while clicking on page number from Ready To Release!.");
            }
        }
    }
}