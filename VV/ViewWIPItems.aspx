<%@ Page Title="View WIP Items" Language="C#" MasterPageFile="~/VV.Master" AutoEventWireup="true"  Culture="en-IN" CodeBehind="ViewWIPItems.aspx.cs" Inherits="VV.ViewWIPItems" %>
    ...
    <table style="height: 100%;" width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td align="left" class="secondLevelHeader" width="10%">
                <asp:Label ID="lblPageTitle" runat="server" Text="View WIP Items" />
        ...
        <tr>
            <td colspan="3">
                ...
                <asp:UpdatePanel ID="EmployeePanel" UpdateMode="always" runat="server">
                    ...
                    CellPadding="3" OnPageIndexChanging="grdViewWIPResult_PageIndexChanging"
                    ...
                    RowStyle-CssClass="Grid_Record" AlternatingRowStyle-CssClass="Grid_Alternate_Record" >    
                       ...
                       <%-- <asp:HyperLinkField DataNavigateUrlFields="OrderNo,LineNum,Pos,SerialNo,ProdOrderNo" DataNavigateUrlFormatString="UpdateWIPToFG.aspx?OrderNo={0}&LineNum={1}&Pos={2}&SerialNo={3}&ProdOrderNo={4}"
                            NavigateUrl="UpdateWIPToFG.aspx"
