    ...
    public partial class UpdateWIPToFG : System.Web.UI.Page
    {
        ...
        protected void buttonUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                _DBObj.UpdateQtyInMISOrderStatusTableForWIPToFG(lblOrderTypeVal.Text.Trim(), lblOrderNoVal.Text.Trim(), lblLineNumVal.Text.Trim(), Int32.Parse(lblPosVal.Text.Trim()), _FGQty, _WIPQty);

                _DBObj.UpdateBalanceQtyInProdOrderReleaseTableForWIPToFG(lblOrderNoVal.Text.Trim(), lblLineNumVal.Text.Trim(), Int32.Parse(lblPosVal.Text.Trim()), lblProdOrderNoVal.Text.Trim(), lblSerialNoVal.Text.Trim(), _BalanceQty);
