...
namespace VV
{
    public partial class OperatorMaster : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                if (txtOperatorCode.Text == string.Empty)
                {
                ...
                else if (txtOperatorName.Text == string.Empty)
                {
                ...
                string operatorCode = txtOperatorCode.Text.Trim();
                string operationName = txtOperatorName.Text.Trim();

                bool IsExist = _dbObj.IsOperatorCodeExist(operatorCode);

                if (IsExist)
                {
                    lblMessage.Visible = true;
                    lblMessage.ForeColor = System.Drawing.Color.Red;
                    lblMessage.Text = "Operator Code already exist in the system. Please try again with new one.";
                    return;
                }

                _dbObj.InsertFromOperatorMaster(operatorCode, operationName);
                ...
                lblMessage.Text = "Operator Master Details Added Successfully.";
            }
            catch (Exception ex)
            {
                LogError(ex, "Exception occured -- insert operation master details.");
            }
            finally
            {
            }
        ...
        protected void btnClear_Click(object sender, EventArgs e)
        {
            ...
            txtOperatorNameSearch.Text = "";
            txtOperatorName.Text = string.Empty;
            txtOperatorCode.Text = string.Empty;

            DataSet searchDS = (DataSet)Cache["CacheFromOperatorMasterDetails"];
        ...
        protected void btnSearchBox_Click(object sender, EventArgs e)
        {
            ...
            string EmployeeName = txtOperatorNameSearch.Text.Trim();

            if (!string.IsNullOrEmpty(EmployeeName))
            {
                searchRowFilter4 = "OperatorName like '%" + EmployeeName + "%'";
            }
            ...
            {
                DBUtil _DBObj = new DBUtil();
                DataSet ds = _DBObj.RetriveByOperatorMasterDetails();
                Cache["CacheFromOperatorMasterDetails"] = ds;
        ...
        protected void GridView1_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            DataSet ds = (DataSet)Cache["CacheFromOperatorMasterDetails"];
            ...
            {
                LogError(ex, "Exception from while clicking on page number from operator master.");
            }
        }
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            try
            {
                ...
                string operatorCode = row.Cells[1].Text;
                string operatorName = ((TextBox)(row.Cells[2].Controls[0])).Text;

                _dbObj.UpdateFormOperatorMaster(operatorCode, operatorName.Trim());
            ...
            {
                LogError(ex, "Exception from while updating row from operator Master.");
            }
        }
        ...
        private void ShowOperatorMasterDetails()
        {
            try
            {
            ...
            {
                LogError(ex, "Exception from display operator master details!");
            }
        }
    }
}