...
namespace VV
{
    public partial class FreezePlan : System.Web.UI.Page
    {
        ...
        protected void btnFreeze_Click(object sender, EventArgs e)
        {
            try
            {
                // Copy the data from MISOrderStatus into MISFinal
            ...
            {
                Logger.Write(this.GetType().ToString() + " : btnFreeze_Click : " + " : " + DateTime.Now + " : " + ex.Message.ToString(), Category.General, Priority.Highest);
                throw ex;
            }
        }
    }
