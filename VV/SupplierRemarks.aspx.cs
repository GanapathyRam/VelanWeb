...
namespace VV
{
    public partial class SupplierRemarks : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                if (txtSupplierRemarks.Text == string.Empty)
                {
                    lblRequiredFields.Visible = true;
                    return;
                }
                string supplierRemarks = txtSupplierRemarks.Text.Trim();

                _dbObj.InsertIntoSupplierRemarks(supplierRemarks);
                ...
                lblMessage.Text = "Supplier Remarks has been added successfully.";
            }
            catch (Exception ex)
            {
                LogError(ex, "Exception occured -- insert supplier remarks.");
            }
            finally
            {
            }
        ...
        protected void btnClear_Click(object sender, EventArgs e)
        {
            ...
            txtSupplierRemarksSearch.Text = "";
            txtSupplierRemarks.Text = string.Empty;

            DataSet searchDS = (DataSet)Cache["CacheFromSupplierRemarks"];
        ...
        protected void btnSearchBox_Click(object sender, EventArgs e)
        {
            ...
            string supplierRemarks = txtSupplierRemarksSearch.Text.Trim();

            if (!string.IsNullOrEmpty(supplierRemarks))
            {
                searchRowFilter4 = "SupplierRemarks like '%" + supplierRemarks + "%'";
            }
            ...
            {
                DBUtil _DBObj = new DBUtil();
                DataSet ds = _DBObj.RetriveBySupplierRemarks();
                Cache["CacheFromSupplierRemarks"] = ds;
        ...
        protected void GridView1_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            DataSet ds = (DataSet)Cache["CacheFromSupplierRemarks"];
            ...
            {
                LogError(ex, "Exception from while clicking on page number from supplier remarks.");
            }
        }
        ...
        private void ShowSupplierRemarks()
        {
            try
            {
            ...
            {
                LogError(ex, "Exception from display supplier remarks!");
            }
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                foreach (GridViewRow row in GridView1.Rows)
                {
                    ...
                    if (isChecked)
                    {
                        var supplierRemarksHidden = ((System.Web.UI.HtmlControls.HtmlInputHidden)row.FindControl("hidRemarksId")).Value.ToString();
                        String supplierRemarks = ((Label)row.FindControl("lblSupplierRemarks")).Text.ToString();

                        _dbObj.DeleteSupplierRemarks(supplierRemarks, Convert.ToInt32(supplierRemarksHidden));
                        lblMessage.Text = "Remarks Removed Successfully.";
                        lblMessage.Visible = true;
                    }
                }
            ...
            {
                LogError(ex, "Exception occured -- delete supplier remarks");
            }
        }
    }
}