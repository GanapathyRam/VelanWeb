<%@ Page Title="View Macro Sales Plan" Language="C#" MasterPageFile="~/VV.Master" AutoEventWireup="true"
    Culture="en-IN" CodeBehind="ViewMacroSalesPlan.aspx.cs" Inherits="VV.ViewMacroSalesPlan" %>
    ...
    <table style="height: 100%;" width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td align="left" class="secondLevelHeader" width="30%">
                <asp:Label ID="lblPageTitle" runat="server" Text="View Macro Sales Plan" />
            </td>
            <%--
                ...
                <asp:UpdatePanel ID="EmployeePanel" UpdateMode="always" runat="server">
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="grdViewReleasePlan" DataKeyNames="customername" ShowHeader="true" AllowSorting="false"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Plan Week" ItemStyle-HorizontalAlign="left" SortExpression="FGWeek">
                                    <ItemTemplate>
                                        <asp:Label ID="lblWeekNo" runat="server" Text='<%# Eval("FGWeek") %>' />
                                    </ItemTemplate>
