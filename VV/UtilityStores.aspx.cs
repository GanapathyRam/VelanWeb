...
namespace VV
{
    public partial class UtilityStores : System.Web.UI.Page
    {
        ...
        private DataSet FillMISStoresDisposition()
        {
            DBUtil _DBObj = new DBUtil();
            DataSet ds = _DBObj.RetriveByMISUtilityStores();
                ...
                if (ddlDisposition.SelectedItem.Text != "----Please Select----" && !string.IsNullOrEmpty(txtRemarks.Text.Trim()))
                {
                    foreach (GridViewRow row in GridView3.Rows)
                    {
                        ...
                        if (isChecked)
                        {
                            ...
                            _dbObj.UpdateMISUtilityStores(Convert.ToDateTime(DateTime.UtcNow.ToString("dd/MM/yyyy")),
        ...
        {
            DataSet ds = (DataSet)Cache["UtilityStoresCache"];
