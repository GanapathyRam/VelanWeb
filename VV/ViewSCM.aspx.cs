...
namespace VV
{
    public partial class ViewSCM : System.Web.UI.Page
    {
        ...
        protected void ddlSupplierName_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                //DataSet ds = _DBObj.RetriveBySupplierNameForViewSCM();
            ...
            {
                LogError(ex, "Exception from View SCM Drop down selection.!");
            }

            ddlSupplierName.SelectedValue = Convert.ToString(ddlSupplierName.SelectedValue);
        }
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ShowViewSCMGrid(Convert.ToInt32(RadioButtonList1.SelectedValue), ddlSupplierName.SelectedItem.Text, Convert.ToInt32(RadioButtonList2.SelectedValue));
            }
            catch (Exception ex)
            {
                LogError(ex, "Exception from search from view scm!");
            }
        ...
        {
            DataSet ds = (DataSet)Cache["CacheFromMISViewSCMFromSuppliers"];
            ...
            {
                LogError(ex, "Exception from View SCM GridView3 PageIndexChanging.");
            }
        }
        ...
        public void ShowViewSCMGrid(int isDueFor, string SupplierName, int IsSelectionFor)
        {
            try
            {
                ...
                DataSet ds = _DBObj.RetriveByMISViewSCMFromSuppliers(isDueFor, SupplierName, IsSelectionFor);

                Cache["CacheFromMISViewSCMFromSuppliers"] = ds;
            ...
            {
                LogError(ex, "Exception from fetch Update View SCM Items");
            }
        }
    }
}