...
namespace VV
{
    public partial class PrimaryBoxEntry : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    if (!string.IsNullOrEmpty(lblBodyHeatNo.Text))
                    {
                        _dbObj.UpdateProdCompletion(lbOrderNo.Text.Trim(), lbLineNo.Text.Trim(), Int32.Parse(lbPos.Text.Trim()), lbProdOrderNo.Text.Trim(), lbSerialNo.Text.Trim(), txProdDeliveryDate.Text.Trim(), txProdComplDate.Text.Trim(), drDwnPrdRem.SelectedItem.Text.Trim());
                    }
                    else
                    {
                        ...
                        ScriptManager.RegisterClientScriptBlock(Page, this.GetType(), "alert",
                            string.Format("alert('{1}', '{0}');", "", "Body Heat No is not available."), true);
                    }
                }
                else
                {
        ...
        public void showgrid()
        {
            ...
            {
                DBUtil _DBObj = new DBUtil();
                DataSet ds = _DBObj.RetrievePrimaryBoxEntry();

                Cache["PrimaryBoxEntryFromDBCache"] = ds;
