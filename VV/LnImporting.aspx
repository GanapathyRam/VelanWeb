<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/VV.Master"
    EnableEventValidation="false" CodeBehind="LnImporting.aspx.cs" Inherits="VV.LnImporting" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="font: 14px Verdana">
        <p style="margin-left: 400px; font-family: Verdana">Import SO Backlog: </p>
        <div style="margin-left: 480px; border-color: red;">
            <asp:FileUpload ID="FileUpload" Width="235px" CssClass="Cntrl" runat="server" />
            &nbsp;<input type="button" id="btImport" class="buttonText" value="Upload" style="width: 80px; cursor:pointer;" onserverclick="btImport_ServerClick" runat="server" />
        </div>
    </div>
