...
namespace VV
{
    public partial class SalesOrderLineItemDeletion : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ShowSalesOrderLineItemDeletion();
            }
        ...
        protected void GridView1_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            DataSet ds = (DataSet)Cache["SalesOrderLineItemForDeletionDBCache"];
            ...
            {
                LogError(ex, "Exception from while clicking on page number from Sale Order Line Item Deletion!.");
            }
        }
        ...
        private void ShowSalesOrderLineItemDeletion()
        {
            try
            {
                ...
                DataSet ds = _DBObj.RetrievesSalesOrderLineItemForDeletion();
                Cache["SalesOrderLineItemForDeletionDBCache"] = ds;
            ...
            {
                LogError(ex, "Exception from display Sale Order Line Item Deletion!");
            }
        }
            ...
            try
            {
                foreach (GridViewRow row in GridView1.Rows)
                {
                    ...
                    if (isChecked)
                    {
                        ...
                        _DBObj.UpdateSalesOrderLineItemDeletion(Convert.ToInt32(lblOrderNo),Convert.ToInt32(lblPos));
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            //{
            //    CheckBox CheckBox1 = (e.Row.FindControl("chkAll") as CheckBox);
        ...
        protected void btnSearchBox_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!String.IsNullOrEmpty(searchRowFilter))
                {
                    DataSet searchDS = (DataSet)Cache["SalesOrderLineItemForDeletionDBCache"];
