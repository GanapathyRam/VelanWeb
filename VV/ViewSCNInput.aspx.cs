...
namespace VV
{
    public partial class ViewSCNInput : System.Web.UI.Page
    {
        ...
        {
            DataSet searchDS = (DataSet)Cache["SCNInputDataFromDBCache"];
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            try
            {
                ...
                TextBox txSCNComplDate = (TextBox)GridView1.Rows[e.RowIndex].FindControl("txtSCNComplDate");
                
                DBUtil _dbObj = new DBUtil();
                _dbObj.UpdateSCNinput(Int32.Parse(lbOrderNo.Text.Trim()), lbLineNo.Text.Trim(), Int32.Parse(lbPos.Text.Trim()), lbProdOrderNo.Text.Trim(), lbSerialNo.Text.Trim(), txSCNComplDate.Text.Trim());
        ...
        public void showgrid()
        {
            ...
            {
                DBUtil _DBObj = new DBUtil();
                DataSet ds = _DBObj.RetrieveSCNInputData();

                Cache["SCNInputDataFromDBCache"] = ds;
        ...
        {
            DataSet ds = (DataSet)Cache["SCNInputDataFromDBCache"];
            ...
            {
                Logger.Write(this.GetType().ToString() + " : View SCN Input - When trying to do a Paging : " + " : " + DateTime.Now + " : " + ex.Message.ToString(), Category.General, Priority.Highest);
                throw ex;
            }
        }
    }
