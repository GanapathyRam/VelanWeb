    ...
    public partial class ViewSCNInput : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            try
            {
                ...
                _dbObj.UpdateSCNinput(lbOrderNo.Text.Trim(), lbLineNo.Text.Trim(), Int32.Parse(lbPos.Text.Trim()), lbProdOrderNo.Text.Trim(), lbSerialNo.Text.Trim(), txSCNComplDate.Text.Trim());
