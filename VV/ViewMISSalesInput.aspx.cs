...
namespace VV
{
    public partial class ViewMISSalesInput : System.Web.UI.Page
    {
        ...
        protected void grdViewBaaNResult_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    String searchRowFilter = "OrderType = '" + txtSearchBox.Text.Trim() + "'";
                    DataView dv;
            ...
            {
                Logger.Write(this.GetType().ToString() + " : View MIS Sales Input - When trying to do a Paging : " + " : " + DateTime.Now + " : " + ex.Message.ToString(), Category.General, Priority.Highest);
                throw ex;
            }
        }
        ...
        protected void btnSearchBox_Click(object sender, EventArgs e)
        {
            ...
            {
                Logger.Write(this.GetType().ToString() + " : View MIS Sales Input - btnSearchBox_Click : " + " : " + DateTime.Now + " : " + ex.Message.ToString(), Category.General, Priority.Highest);
                throw ex;
            }
