...
namespace VV
{
    public partial class AnalysisDateSet : System.Web.UI.Page
    {
        ...
        private void FillPatrolAnalysisDataSet()
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(txtFromDate.Text.Trim()) && !string.IsNullOrEmpty(txtToDate.Text.Trim()))
                {
                    ...
                    {
                        Cache["CacheFromPatrolAnalysisDataSet"] = ds;
        ...
        {
            DataSet ds = (DataSet)Cache["CacheFromPatrolAnalysisDataSet"];
            ...
            {
                LogError(ex, "Exception from while clicking on page number from patrol analysis dataset.");
            }
        }
        ...
        protected void imgExcelForPending_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(txtFromDate.Text.Trim()) && !string.IsNullOrEmpty(txtToDate.Text.Trim()))
                {
                    ds = (DataSet)Cache["CacheFromPatrolAnalysisDataSet"];
                    fileName = "PatrolAnalysisDateWise.xls";
