...
namespace VV
{
    public partial class ViewMacroReleasePlan : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                String WeekNo = Request.QueryString["WeekNo"].Trim();

                DataSet ds = _dbObj.GetMacroReleasePlanData(Int32.Parse(WeekNo));

                Cache["MacroReleaseDataFromDBCache"] = ds;
        ...
        protected void grdViewReleasePlan_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            try
            {
                DataSet ds = (DataSet)Cache["MacroReleaseDataFromDBCache"];
            ...
            {
                Logger.Write(this.GetType().ToString() + " : grdViewReleasePlan_PageIndexChanging : " + " : " + DateTime.Now + " : " + ex.Message.ToString(), Category.General, Priority.Highest);
                throw ex;
            }
        }
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Convert(ds, "Macro Release Plan Data");
            }
            catch (Exception ex)
            {
