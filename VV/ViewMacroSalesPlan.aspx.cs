...
namespace VV
{
    public partial class ViewMacroSalesPlan : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataSet ds = _dbObj.GetMacroSalesPlanData(Int32.Parse(WeekNo));

                Cache["MacroSalesDataFromDBCache"] = ds;
        ...
        protected void grdViewReleasePlan_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            try
            {
                DataSet ds = (DataSet)Cache["MacroSalesDataFromDBCache"];
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Convert(ds, "Macro Sales Plan Data");
            }
            catch (Exception ex)
            {
