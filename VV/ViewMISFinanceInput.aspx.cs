...
namespace VV
{
    public partial class ViewMISFinanceInput : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                DataSet ds = _dbObj.RetrieveBaaNDataForMISFinanceInput();
        ...
        protected void grdViewBaaNResult_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    String searchRowFilter = "OrderNo = '" + txtSearchBox.Text.Trim() + "'";
                    DataView dv;
            ...
            {
                Logger.Write(this.GetType().ToString() + " : View MIS Finance Input - When trying to do a Paging : " + " : " + DateTime.Now + " : " + ex.Message.ToString(), Category.General, Priority.Highest);
                throw ex;
            }
        }
        ...
        protected void btnSearchBox_Click(object sender, EventArgs e)
        {
            try
            {
                //DataSet searchDS1 = (DataSet)Cache["ImportedBaanFromDBCache"];
                //searchDS1.WriteXml(@"E:\Sam.xls");
                //ExporttoExcel(searchDS1.Tables[0]);
            ...
            {
                Logger.Write(this.GetType().ToString() + " : View MIS Finance Input - btnSearchBox_Click : " + " : " + DateTime.Now + " : " + ex.Message.ToString(), Category.General, Priority.Highest);
                throw ex;
            }

        }

        protected void ExporttoExcel(DataTable table)
        {
...
HttpContext.Current.Response.Write(table.Columns[j].ColumnName.ToString());
        ...
        public void ExportToExcel_Orig()
        {
            //DataSet objDataset = new DataSet();
            //objDataset = (DataSet)Cache["ImportedBaanFromDBCache"];

            ////Create the FileStream to write with.
            //System.IO.FileStream fs = new System.IO.FileStream(Server.MapPath("MISFinancialInput.xml"), System.IO.FileMode.Create);
            ...
            //xtw.WriteProcessingInstruction("xml-stylesheet", "type='text/xsl' href='MISFinancialInput.xsl'");
            ...
            //ds.ReadXml(Server.MapPath("MISFinancialInput.xml"));
            //XmlDataDocument xdd = new XmlDataDocument(ds);
            //XslTransform xt = new XslTransform();
            //xt.Load(Server.MapPath("MISFinancialInput.xsl"));
