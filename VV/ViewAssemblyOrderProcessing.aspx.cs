...
namespace VV
{
    public partial class ViewAssemblyOrderProcessing : System.Web.UI.Page
    {
        ...
        protected void grdViewAssemblyPlan_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            try
            {
                DataSet ds = (DataSet)Cache["AssemblyDataFromDBCache"];

                grdViewAssemblyPlan.PageIndex = e.NewPageIndex;
                grdViewAssemblyPlan.DataSource = ds;
                grdViewAssemblyPlan.DataBind();
            }
        ...
        protected void btnSearchBox_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataSet ds = _dbObj.GetAssemblyOrderProcessing(ProdOrderNo_Search.Trim());

                Cache["AssemblyDataFromDBCache"] = ds;
                grdViewAssemblyPlan.DataSource = ds;
                grdViewAssemblyPlan.DataBind();
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Convert(ds, "Assembly Order Processing Data");
            }
            catch (Exception ex)
            {
