...
namespace VV
{
    public partial class CreateNewUser : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Logger.Write(this.GetType().ToString() + " :CreateNewUser - Page_Load : " + " : " + DateTime.Now + " : " + ex.Message.ToString(), Category.General, Priority.Highest);
                throw ex;
            }
        }
        ...
        protected void buttonUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!_DBObj.GetLoginIsExist(UserName))
                {

                    _DBObj.CreateNewUser(UserName, Password);

                    _DBObj.InsertScreenAccess(UserName);
                ...
                {
                    lblMessage.Visible = true;
                    lblMessage.Text = "User already exist in the system. Please try again with new user.";
                }

            }
            catch (Exception ex)
            {
                Logger.Write(this.GetType().ToString() + " :Create New User - buttonUpdate_Click : " + " : " + DateTime.Now + " : " + ex.Message.ToString(), Category.General, Priority.Highest);
                throw ex;
            }
        }
