<%@ Page Title="View QR And QA" Language="C#" MasterPageFile="~/VV.Master" AutoEventWireup="true" Culture="en-IN" CodeBehind="ViewQRAndQA.aspx.cs" Inherits="VV.ViewQRAndQA" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <table style="height: 100%;" width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td align="left" class="secondLevelHeader" width="7%">
                <asp:Label ID="lblPageTitle" runat="server" Text="View QR & QA" />            
            </td> 
                ...
                <asp:GridView ID="grdViewResult" DataKeyNames="OrderNo" ShowHeader="true" AllowSorting="false" AllowPaging="true" 
                    ...
                    <Columns>
                       ...
                       <%-- <asp:TemplateField HeaderText="Amount (INR)"  ItemStyle-HorizontalAlign="Right" SortExpression="Amount" >
                            <ItemTemplate>
                                <asp:Label ID="lblAmount" runat="server" Text='<%# Eval("Amount","{0:c0}") %>' data />
                            </ItemTemplate>
                            <ItemStyle Wrap="false" />
                        </asp:TemplateField>--%>
