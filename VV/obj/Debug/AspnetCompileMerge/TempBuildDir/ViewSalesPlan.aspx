<%@ Page Title="View Sales Plan" Language="C#" MasterPageFile="~/VV.Master" AutoEventWireup="true"
    Culture="en-IN" CodeBehind="ViewSalesPlan.aspx.cs" Inherits="VV.ViewSalesPlan" %>
    ...
    <table style="height: 100%;" width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td align="left" class="secondLevelHeader" width="30%">
                <asp:Label ID="lblPageTitle" runat="server" Text="View Sales Plan" />
            </td>
            <%--
            To show the Progress Bar image when any of the operations are done--%>
            <td class="secondLevelHeader" align="left" width="10%">
            <asp:Button ID="btnMacro" runat="server" CssClass="buttonText" OnClientClick="return CheckWeekNo()" Text="View Macro Data" OnClick="btnMacro_Click" Width="100"></asp:Button>
        ...
        <tr>
            <td colspan="3">
                ...
                <asp:UpdatePanel ID="EmployeePanel" UpdateMode="always" runat="server">
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="grdViewSalesPlan" DataKeyNames="OrderNo" ShowHeader="true" AllowSorting="false"
                            AllowPaging="true" AutoGenerateColumns="false" runat="server" EmptyDataText="No Records To Display"
                            CellPadding="3" PageSize="24" OnPageIndexChanging="grdViewSalesPlan_PageIndexChanging"
                            ...
                            <Columns>
                               <asp:TemplateField HeaderText="Sales Week" ItemStyle-HorizontalAlign="left" SortExpression="WeekNo">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="FG Val" ItemStyle-HorizontalAlign="Right" SortExpression="FGVal">
                                    <ItemTemplate>
                                        <asp:Label ID="lblFGVal" runat="server" BackColor="LightGreen" Text='<%# Eval("FGVal","{0:c0}") %>' />
                                    </ItemTemplate>
                                    <ItemStyle Wrap="false" />
                                </asp:TemplateField>
