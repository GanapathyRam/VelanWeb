<%@ Page Title="Prod Order Reversal" Language="C#" MasterPageFile="~/VV.Master" AutoEventWireup="true" Culture="en-IN" CodeBehind="ProdOrderReversal.aspx.cs" Inherits="VV.ProdOrderReversal" %>
    ...
    <table style="height: 100%;" width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td align="left" class="secondLevelHeader" width="10%">
                <asp:Label ID="lblPageTitle" runat="server" Text="Prod Order Reversal" />
            ...
            <td width="80%" align="right" style="padding-left: 270px;" class="secondLevelHeader">
                ...
                <asp:Panel ID="SearchPanel" DefaultButton="btnSearchBox" runat="server">
                    <asp:Button ID="btnReverse" Text="Reverse Prod Order" runat="server" CssClass="buttonText" OnClick="btnReverse_Click" Visible="true" Width="113px" />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   
...
<%--                            <ItemStyle Width="100px" />
                        ...
                        <asp:TemplateField HeaderText="To Release Qty"  ItemStyle-HorizontalAlign="left" SortExpression="ToReleaseQty">
                            ...
                            <HeaderStyle Width="100px" />--%>
                               ...
                               <%-- <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="left" SortExpression="" Visible="false">
                                    <ItemTemplate>
                                        <input id="hidStoresIssued" value='<%# Eval("StoresIssued") %>' type="hidden" runat="server" />
                                    </ItemTemplate>
                                    <ItemStyle Wrap="false" />
                                    <%--                            <ItemStyle Width="100px" />
                            <HeaderStyle Width="100px" />
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:HiddenField ID="hidStoresIssued" Value='<%# Eval("StoresIssued") %>' runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
