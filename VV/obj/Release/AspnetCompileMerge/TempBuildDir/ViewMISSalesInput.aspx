<%@ Page Title="View MIS Sales Input" Language="C#" MasterPageFile="~/VV.Master" AutoEventWireup="true" Culture="en-IN" CodeBehind="ViewMISSalesInput.aspx.cs" Inherits="VV.ViewMISSalesInput" %>
     ...
     <table style="height: 100%;" width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td align="left" class="secondLevelHeader" width="30%">
                <asp:Label ID="lblPageTitle" runat="server" Text="View MIS Sales Input" />            
            </td> 
            ...
            <td width="60%" align="left" style="padding-left:500px;" class="secondLevelHeader">
                ...
                <asp:Panel ID="SearchPanel" DefaultButton="btnSearchBox" runat="server">
                    <asp:TextBox ID="txtSearchBox" runat="server" ToolTip="Enter OrderType to be Searched" onKeyUp="ControlSearch(this)"/>
        ...
        <tr>
            ...
            <Triggers>
                ...
                <asp:GridView ID="grdViewBaaNResult" EnableViewState="false" DataKeyNames="OrderNo" ShowHeader="true" AllowSorting="false" AllowPaging="true" 
                    ...
                    <Columns>
                        <asp:HyperLinkField DataNavigateUrlFields="OrderNo,LineNum,Pos" DataNavigateUrlFormatString="UpdateMISSalesInput.aspx?OrderNo={0}&LineNum={1}&Pos={2}"
                            NavigateUrl="UpdateMISSalesInput.aspx"
