<%@ Page Title="View Macro Release Plan" Language="C#" MasterPageFile="~/VV.Master" AutoEventWireup="true"
    Culture="en-IN" CodeBehind="ViewMacroReleasePlan.aspx.cs" Inherits="VV.ViewMacroReleasePlan" %>
    ...
    <table style="height: 100%;" width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td align="left" class="secondLevelHeader" width="30%">
                <asp:Label ID="lblPageTitle" runat="server" Text="View Macro Release Plan" />
            </td>
            <%--
                ...
                <asp:UpdatePanel ID="EmployeePanel" UpdateMode="always" runat="server">
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="grdViewReleasePlan" DataKeyNames="customername" ShowHeader="true" AllowSorting="false"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Plan Week" ItemStyle-HorizontalAlign="left" SortExpression="PlanWeek">
                                    <ItemTemplate>
                                        <asp:Label ID="lblWeekNo" runat="server" Text='<%# Eval("PlanWeek") %>' />
                                    </ItemTemplate>
