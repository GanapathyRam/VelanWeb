            ...
            <ContentTemplate>
                <asp:GridView ID="GridView3" Style="margin-left: 125px; margin-bottom: 20px;" runat="server" Width="80%" runat="server" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Count(Upto 14)">
                        ...
                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Qty(Upto 14)">
                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Count(15 to 30)">
                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Qty(15 to 30)">
                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Count(31 to 60)">
                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Qty(31 to 60)">
                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Count(61 to 90)">
                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Qty(61 to 90)">
                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Count(Above 90)">
                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Qty(Above 90)">
                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
