<%@ Page Title="Bulk TPI Offering" Language="C#" AutoEventWireup="true"
    CodeBehind="BulkTPIOffering.aspx.cs" Inherits="VV.BulkTPIOffering" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Bulk TPI Offering</title>
...
<body>
    ...
    <table>
        ...
        <tr>
            <td align="right" class="detailTableRowHead">
                <asp:Label ID="Label3" runat="server" Text="TPI Offer Date"></asp:Label>
            </td>
            <td align="left" class="detailTableRowContent">
                <asp:TextBox ID="txtTPIOfferDate" CssClass="inputStyle" runat="server" Width="120"></asp:TextBox>
        ...
        <tr>
            <td align="right" class="detailTableRowHead">
                <asp:Label ID="Label4" runat="server" Text="IRN Comp Date"></asp:Label>
            </td>
            <td align="left" class="detailTableRowContent">
                <asp:TextBox ID="txtIRNCompDate" CssClass="inputStyle" runat="server" Width="120"></asp:TextBox>
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtIRNCompDate"
                    ValidationExpression="^(0?[1-9]|[12][0-9]|3[01])[-](0?[1-9]|1[012])[-]\d{4}$"
                    ErrorMessage="Format: dd-MM-yyyy" Display="Dynamic"></asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr>
            ...
            <td align="left" class="detailTableRowContent">
               <asp:TextBox ID="txtRemarks" CssClass="inputStyle" runat="server" Width="120"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
