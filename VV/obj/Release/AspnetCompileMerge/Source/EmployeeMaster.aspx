<%@ Page Title="Employee Master" MasterPageFile="~/VV.Master" Culture="en-IN" Language="C#" AutoEventWireup="true"
    CodeBehind="EmployeeMaster.aspx.cs" EnableEventValidation="false" Inherits="VV.EmployeeMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top: 20px;">
        <tr>
            ...
            <td style="padding-left: 10px; width: 220px;">
                <asp:TextBox ID="txtEmployeeName" Height="15px" CssClass="textBox" runat="server"></asp:TextBox></td>
            <td>
                <asp:Label ID="lblRequiredFields" Text="Please Enter Employee Name." Visible="false" ForeColor="Red" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        ...
        <tr>
            <td style="margin-left: 100px; text-align: right; font-family: Verdana;">
                <asp:Label ID="lblEmployeeCode" Text="Velan Employee Code" runat="server"></asp:Label></td>
            <td style="padding-left: 10px; width: 220px;">
                <asp:TextBox ID="txtVelanEmployeeCode" Height="15px" CssClass="textBox" runat="server"></asp:TextBox></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>
        <tr>
            ...
            <td style="padding-left: 10px; width: 220px;">
                <asp:TextBox ID="txtEmail" Height="15px" CssClass="textBox" runat="server"></asp:TextBox></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>
        <tr>
            <td style="margin-left: 100px; text-align: right; font-family: Verdana;">
                <asp:Label ID="lblDC" Text="DC" runat="server"></asp:Label></td>
            <td style="padding-left: 10px; width: 220px;">
                <asp:CheckBox ID="CheckBox1" CssClass="textBox" runat="server" />
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
    ...
    <div style="margin-left: 800px; text-align: center; font-family: Verdana;">
        <asp:Label ID="lblEmployeeNameSearch" runat="server" Text="Employee Name"></asp:Label>
        <asp:TextBox ID="txtEmployeeNameSearch" Height="20px" Width="200px" runat="server" ToolTip="Enter Employee Name to be Searched" onKeyUp="ControlSearch(this)" />
        ...
        <asp:UpdatePanel ID="EmployeePanel" UpdateMode="always" runat="server">
            <ContentTemplate>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="true"
                    OnRowCancelingEdit="GridView1_RowCancelingEdit" DataKeyNames="EmployeeCode" AllowPaging="true" PageSize="24"
