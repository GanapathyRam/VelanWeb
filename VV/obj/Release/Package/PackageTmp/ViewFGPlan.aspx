<%@ Page Title="View FG Plan" Language="C#" MasterPageFile="~/VV.Master" AutoEventWireup="true"
    Culture="en-IN" CodeBehind="ViewFGPlan.aspx.cs" Inherits="VV.ViewFGPlan" %>
    ...
    <table style="height: 100%;" width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td align="left" class="secondLevelHeader" width="30%">
                <asp:Label ID="lblPageTitle" runat="server" Text="View FG Plan" />
            </td>
            <%--
        ...
        <tr>
            <td colspan="3">
                ...
                <asp:UpdatePanel ID="EmployeePanel" UpdateMode="always" runat="server">
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="grdViewFGPlan" DataKeyNames="OrderNo" ShowHeader="true" AllowSorting="false"
                            AllowPaging="true" AutoGenerateColumns="false" runat="server" EmptyDataText="No Records To Display"
                            CellPadding="3" PageSize="24" OnPageIndexChanging="grdViewFGPlan_PageIndexChanging"
                            ...
                            <Columns>
                               <asp:TemplateField HeaderText="FG Week" ItemStyle-HorizontalAlign="left" SortExpression="WeekNo">
                                    <ItemTemplate>
