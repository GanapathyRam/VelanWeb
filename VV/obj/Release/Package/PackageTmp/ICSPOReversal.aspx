<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/VV.Master" Culture="en-IN"
     CodeBehind="ICSPOReversal.aspx.cs" Inherits="VV.ICSPOReversal" %>
    ...
    <table style="height: 100%;" width="100%" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td width="80%" align="right" style="padding-left: 270px;" class="secondLevelHeader">
                ...
                <asp:Button ID="btnReverse" Text="Reverse Prod Order" runat="server" CssClass="buttonText" OnClick="btnReverse_Click" Visible="true"/>
