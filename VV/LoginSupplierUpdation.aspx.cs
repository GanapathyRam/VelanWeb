...
namespace VV
{
    public partial class LoginSupplierUpdation : System.Web.UI.Page
    {
        ...
        private void ShowSupplierNameDetails()
        {
            try
            {
                ...
                DataSet ds = _DBObj.RetriveBySupplierNameDetails();

                Cache["CacheFromSupplierNameDetails"] = ds;
            ...
            {
                LogError(ex, "Exception from display supplier master details!");
            }
        }
        ...
        {
            DataSet ds = (DataSet)Cache["CacheFromSupplierNameDetails"];
            ...
            try
            {
                if (!String.IsNullOrEmpty(txtSupplierNameSearch.Text.Trim()))
                {
                    String searchRowFilter = "SupplierName = '" + txtSupplierNameSearch.Text.Trim() + "'";
                    DataView dv;
            ...
            {
                LogError(ex, "Exception from grid view page indexing!");
            }
        }
        ...
        protected void GridView1_RowEditing(object sender, GridViewEditEventArgs e)
        {
            ...
            DataSet searchDS = (DataSet)Cache["CacheFromSupplierNameDetails"];
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            try
            {
                HiddenField lblUserId = GridView1.Rows[e.RowIndex].FindControl("hidUserId") as HiddenField;
                Label lblUserName = (Label)GridView1.Rows[e.RowIndex].FindControl("lblUserName");
                TextBox txtSupplierName = (TextBox)GridView1.Rows[e.RowIndex].FindControl("txtSupplierName");

                DBUtil _dbObj = new DBUtil();
                _dbObj.UpdateSupplierNameDetails(Int32.Parse(lblUserId.Value), lblUserName.Text.Trim(), txtSupplierName.Text.Trim());
                ...
                lblMessage.Text = "Supplier Name has been updated successfully!";
            }
            catch (Exception ex)
            {
                LogError(ex, "Exception from updating supplier master details!");
            }
        }
        ...
        protected void btnSearchBox_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //    DataSet searchDS = (DataSet)Cache["CacheFromSupplierNameDetails"];
                //    String searchRowFilter = "SupplierName = '" + txtSupplierNameSearch.Text.Trim() + "'";
                //    DataView dv = searchDS.Tables[0].DefaultView;
                //    dv.RowFilter = searchRowFilter;
                ...
                string supplierName = txtSupplierNameSearch.Text.Trim();
            ...
            {
                LogError(ex, "Exception from search supplier master details!");
            }
        }
    }
}