...
namespace VV
{
    public partial class ViewMacroFGPlan : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataSet ds = _dbObj.GetMacroFGPlanData(Int32.Parse(WeekNo));

                Cache["MacroFGDataFromDBCache"] = ds;
        ...
        protected void grdViewReleasePlan_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            try
            {
                DataSet ds = (DataSet)Cache["MacroFGDataFromDBCache"];
