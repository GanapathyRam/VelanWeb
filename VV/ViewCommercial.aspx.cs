...
namespace VV
{
    public partial class ViewCommercial : System.Web.UI.Page
    {
        ...
        protected void grdViewResult_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            try
            {
                DataSet ds = (DataSet)Cache["CommercialDataFromDBCache"];
        ...
        protected void btnSearchBox_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                searchDS = _dbObj.GetCommercialData(ChosenOrderType, Int32.Parse(txtWeekNo.Text.Trim()));

                Cache["CommercialDataFromDBCache"] = searchDS;
